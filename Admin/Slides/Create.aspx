<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMP.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="KargahProject.Admin.Slides.Create" %>
        ...
        <section class="main_artc">
            ...
            <fieldset name="AddProduct">
                ...
                <div class="form-item">
                    <div class="user_pic">
                        <div runat="server">
                            <input type="file" class="required" id="file" name="file" onchange="setpic(this);" />
                ...
                <footer class="btn_holder">
                    <div class="sub_btn">
                        <input type="submit" value="افزودن" runat="server" onserverclick="CreateSlide_ServerClick"/>
                    </div>
                </footer>
